...
[![Go Report Card](https://goreportcard.com/badge/github.com/mymilkbottles/cmd)](https://goreportcard.com/report/github.com/mymilkbottles/cmd)
...
------------
```bash
go get -u github.com/mymilkbottles/cmd/revel
```
